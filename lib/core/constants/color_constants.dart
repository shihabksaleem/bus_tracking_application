...
class ColorConstants {
  ...
  static const Color mainBlue = Color(0xff0097878);
  static const Color mainLightBlue = Color(0xffACE2E1);
  static const Color lightyellow = Color(0xffFFF3C7);
  static const Color lightPink = Color(0xffFB9AD1);
