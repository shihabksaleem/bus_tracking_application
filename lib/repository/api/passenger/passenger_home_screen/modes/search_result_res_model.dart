...
class SearchResultResModel {
  ...
  factory SearchResultResModel.fromJson(Map<String, dynamic> json) =>
      SearchResultResModel(
        ...
        buses: json["buses"] == null
            ? []
            : List<Bus>.from(json["buses"]!.map((x) => Bus.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "buses": buses == null
            ? []
            : List<dynamic>.from(buses!.map((x) => x.toJson())),
      };
}
...
class Bus {
  ...
  factory Bus.fromJson(Map<String, dynamic> json) => Bus(
        ...
        routeAssignments: json["route_assignments"] == null
            ? []
            : List<RouteAssignment>.from(json["route_assignments"]!
                .map((x) => RouteAssignment.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "is_active": isActive,
        "busowner": busowner,
        "route_assignments": routeAssignments == null
            ? []
            : List<dynamic>.from(routeAssignments!.map((x) => x.toJson())),
      };
}
